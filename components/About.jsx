  ...
  return (
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        ...
        <div
          data-aos="flip-right"
          className="w-ful h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4"
        >
          <Image
            className="rounded-xl  hover:scale-95 ease-in duration-300"
            src={AboutIMG}
            alt="about"
          />
        </div>
